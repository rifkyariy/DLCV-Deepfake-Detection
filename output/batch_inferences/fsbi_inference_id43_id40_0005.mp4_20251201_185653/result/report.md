# Inference Report — id43_id40_0005.mp4

## Overview
- **Process ID:** fsbi_inference_id43_id40_0005.mp4_20251201_185653
- **Timestamp:** 2025-12-01T18:57:03.117619
- **Device:** cuda
- **Weights:** /app/weights/best_model.tar
- **Input Image:** /app/input/inference_samples/id43_id40_0005.mp4.jpg
...
- Bounding box (x0, y0, x1, y1): [48.0, 41.0, 332.0, 341.0]
- Landmarks (x, y): [[129.0, 147.0], [257.0, 156.0], [188.0, 213.0], [124.0, 261.0], [242.0, 265.0]]
...
### Statistics
- **Blended tensor:** mean 0.6900, std 0.2883, min 0.1384, max 1.5004
- **cA_r:** mean 0.8282, std 0.3122
- **cA_g:** mean 0.8922, std 0.3573
- **cA_b:** mean 1.0387, std 0.4432
...
## Step E — Classifier
- Logits: [-4.763512134552002, 4.615484714508057]
- Probabilities: [8.447276923106983e-05, 0.9999154806137085]
- Predicted label: **fake**
- Class confidence: 0.9999