# Inference Report — id46_id41_0000.mp4

## Overview
- **Process ID:** fsbi_inference_id46_id41_0000.mp4_20251201_185722
- **Timestamp:** 2025-12-01T18:57:32.565545
- **Device:** cuda
- **Weights:** /app/weights/best_model.tar
- **Input Image:** /app/input/inference_samples/id46_id41_0000.mp4.jpg
...
- Bounding box (x0, y0, x1, y1): [42.0, 38.0, 339.0, 351.0]
- Landmarks (x, y): [[158.0, 145.0], [276.0, 190.0], [213.0, 214.0], [125.0, 256.0], [224.0, 292.0]]
...
### Statistics
- **Blended tensor:** mean 0.7462, std 0.4052, min 0.0086, max 1.4722
- **cA_r:** mean 0.9319, std 0.4952
- **cA_g:** mean 0.9124, std 0.5057
- **cA_b:** mean 1.1403, std 0.5878
...
## Step E — Classifier
- Logits: [-3.7542495727539062, 3.5913901329040527]
- Probabilities: [0.0006449840730056167, 0.9993550181388855]
- Predicted label: **fake**
- Class confidence: 0.9994