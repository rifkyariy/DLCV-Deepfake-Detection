# Inference Report — 00197.mp4

## Overview
- **Process ID:** fsbi_inference_00197.mp4_20251201_185805
- **Timestamp:** 2025-12-01T18:58:14.975249
- **Device:** cuda
- **Weights:** /app/weights/best_model.tar
- **Input Image:** /app/input/inference_samples/00197.mp4.jpg
...
- Bounding box (x0, y0, x1, y1): [46.0, 34.0, 328.0, 346.0]
- Landmarks (x, y): [[121.0, 153.0], [251.0, 157.0], [183.0, 207.0], [121.0, 261.0], [242.0, 260.0]]
...
### Statistics
- **Blended tensor:** mean 0.5485, std 0.3448, min -0.0013, max 1.4326
- **cA_r:** mean 0.5860, std 0.3362
- **cA_g:** mean 0.6571, std 0.3789
- **cA_b:** mean 0.9493, std 0.5515
...
## Step E — Classifier
- Logits: [1.8267455101013184, -1.804017186164856]
- Probabilities: [0.974187970161438, 0.0258120559155941]
- Predicted label: **real**
- Class confidence: 0.9742