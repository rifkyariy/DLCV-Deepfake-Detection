# Inference Report — id37_id3_0004.mp4

## Overview
- **Process ID:** fsbi_inference_id37_id3_0004.mp4_20251201_185750
- **Timestamp:** 2025-12-01T18:58:00.654741
- **Device:** cuda
- **Weights:** /app/weights/best_model.tar
- **Input Image:** /app/input/inference_samples/id37_id3_0004.mp4.jpg
...
- Bounding box (x0, y0, x1, y1): [44.0, 34.0, 336.0, 347.0]
- Landmarks (x, y): [[133.0, 164.0], [261.0, 152.0], [207.0, 209.0], [155.0, 272.0], [266.0, 261.0]]
...
### Statistics
- **Blended tensor:** mean 0.4786, std 0.3165, min -0.0012, max 1.3581
- **cA_r:** mean 0.4706, std 0.3178
- **cA_g:** mean 0.5536, std 0.3482
- **cA_b:** mean 0.8862, std 0.4635
...
## Step E — Classifier
- Logits: [-4.647324085235596, 4.492074489593506]
- Probabilities: [0.00010734034003689885, 0.9998925924301147]
