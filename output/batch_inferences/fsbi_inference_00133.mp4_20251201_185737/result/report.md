# Inference Report — 00133.mp4

## Overview
- **Process ID:** fsbi_inference_00133.mp4_20251201_185737
- **Timestamp:** 2025-12-01T18:57:45.991922
- **Device:** cuda
- **Weights:** /app/weights/best_model.tar
- **Input Image:** /app/input/inference_samples/00133.mp4.jpg
...
- Bounding box (x0, y0, x1, y1): [44.0, 28.0, 334.0, 344.0]
- Landmarks (x, y): [[127.0, 136.0], [259.0, 156.0], [188.0, 205.0], [116.0, 256.0], [233.0, 269.0]]
...
### Statistics
- **Blended tensor:** mean 0.4495, std 0.2502, min 0.0246, max 1.5001
- **cA_r:** mean 0.4956, std 0.2591
- **cA_g:** mean 0.4486, std 0.2465
- **cA_b:** mean 0.8530, std 0.3309
...
## Step E — Classifier
- Logits: [2.641545057296753, -2.703242540359497]
- Probabilities: [0.9952496290206909, 0.00475029181689024]
- Predicted label: **real**
- Class confidence: 0.9952