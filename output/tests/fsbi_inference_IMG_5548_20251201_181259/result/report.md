# Inference Report — IMG_5548

## Overview
- **Process ID:** fsbi_inference_IMG_5548_20251201_181259
- **Timestamp:** 2025-12-01T18:13:10.048079
- **Device:** cuda
- **Weights:** /app/weights/best_model.tar
- **Input Image:** /app/input/test/IMG_5548.jpg
- **Grad-CAM target:** fake (index 1)

## Step A — Input Image
- Dimensions: 968x775 (HxW)
...
- Bounding box (x0, y0, x1, y1): [250.0, 219.0, 588.0, 731.0]
- Landmarks (x, y): [[354.0, 448.0], [509.0, 431.0], [452.0, 552.0], [388.0, 622.0], [508.0, 612.0]]
...
### DWT Statistics
- **Blended tensor:** mean 0.6899, std 0.3747, min 0.0035, max 1.4935
- **cA_r (red):** mean 0.8788, std 0.5154
- **cA_g (green):** mean 0.8667, std 0.5153
- **cA_b (blue):** mean 1.0154, std 0.4512
...
## Step E — Classifier
- Logits: [2.5465574264526367, -2.6357665061950684]
- Probabilities: [0.994416356086731, 0.00558359082788229]
- Predicted label: **real**
- Class confidence: 0.9944