# Inference Report — IMG_5545

## Overview
- **Process ID:** fsbi_inference_IMG_5545_20251201_181314
- **Timestamp:** 2025-12-01T18:13:24.233431
- **Device:** cuda
- **Weights:** /app/weights/best_model.tar
- **Input Image:** /app/input/test/IMG_5545.jpg
- **Grad-CAM target:** fake (index 1)

## Step A — Input Image
- Dimensions: 630x527 (HxW)
...
- Bounding box (x0, y0, x1, y1): [166.0, 21.0, 419.0, 328.0]
- Landmarks (x, y): [[220.0, 111.0], [330.0, 135.0], [249.0, 180.0], [200.0, 229.0], [299.0, 248.0]]
...
### DWT Statistics
- **Blended tensor:** mean 0.6786, std 0.1935, min 0.3525, max 1.4971
- **cA_r (red):** mean 0.8472, std 0.2437
- **cA_g (green):** mean 0.8910, std 0.2499
- **cA_b (blue):** mean 0.9751, std 0.2638
...
## Step E — Classifier
- Logits: [-1.3665986061096191, 1.401398777961731]
- Probabilities: [0.05907824635505676, 0.9409217238426208]
- Predicted label: **fake**
- Class confidence: 0.9409